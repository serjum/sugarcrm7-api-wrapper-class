...
class Guzzle6 implements ClientInterface
{
    ...
    {
        $result = $this->request('GET', $endpoint, [ 'query' => $parameters ]);
    ...
    public function postFile($endpoint, $parameters = [])
    {
        ...
        $result = $this->request('POST', $endpoint, $parameters, false);
    ...
    {
        $result = $this->request('POST', $endpoint, [ 'json' => $parameters ]);
    ...
    {
        $result = $this->request('PUT', $endpoint, [ 'json' => $parameters ]);
